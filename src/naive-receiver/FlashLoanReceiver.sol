...
contract FlashLoanReceiver is IERC3156FlashBorrower {
    ...
    // @audit Missing access controls allow anyone to take out a flash loan on this contracts behalf
    // The first value in onFlashLoan is ignored, but this value is the originator of the flash loan acting as a sudo msg.sender
    // Ignoring this value allows anyone to initiate a flash loan to this contract by passing this contracts address as the receiver into the NativeReceiverPool::flashLoan function
